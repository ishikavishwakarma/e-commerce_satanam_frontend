...
import { ChevronDownIcon, ChevronLeftIcon, ChevronRightIcon, FunnelIcon, MinusIcon, PlusIcon, Squares2X2Icon, StarIcon, XMarkIcon } from '@heroicons/react/20/solid';
...
import { getUserAllCard } from '../store/Actions/CardAction';
...
const UserProducts = () => {
    ...
    useEffect(() => {
      ...
      //   dispatch(getFilterProduct(filterValue, sort, pagination, searchText));
      // }, [dispatch, sort, filterValue, page, searchText]);
